...
> [合约升级](https://hardhat.org/ignition/docs/guides/upgradeable-proxies)

### 2. sepolia已部署合约地址参考`igniton/deployments/deployed_addresses.json`
...
sepolia使用configvarialbe设置环境变量SEPOLIA\_RPC\_URL,SEPOLIA\_PRIVATE\_KEY,SEPOLIA\_ETHERSCAN\_API\_KEY参考

> [use configvariable](https://hardhat.org/docs/tutorial/configuration-variables)
